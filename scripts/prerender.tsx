...
const expected = { cleanUrls: true, trailingSlash: false, redirects: Object.entries(legacyReviewRedirects).map(([source, destination]) => ({ source, destination, permanent: true })) };
