  ...
  return (
    <div className="min-h-screen bg-brand-bg flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-white font-bold text-3xl font-mono mb-4">SaaS Cost Audit</h1>
        <p className="text-gray-400 text-lg mb-8 leading-relaxed">
          Get an AI-powered audit of your software stack with exact savings calculated. Launching very soon.
        </p>
