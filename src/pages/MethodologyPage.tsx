...
export function MethodologyPage() {
  return <main className="max-w-3xl mx-auto px-6 pt-28 pb-20 text-gray-300 leading-relaxed">
    <h1 className="text-3xl md:text-5xl text-white font-bold mb-8">How to read our reviews</h1>
    ...
    <p>Vendor documentation is the source for current pricing and product specifications. Follow the source links in a review before buying: prices can vary by billing period, region, tax, usage and plan. Vendor benchmarks are not our own test results and are not directly comparable without the same task set and evaluation conditions.</p>
    <h2 className="text-2xl text-white font-bold mt-10 mb-4">Savings examples</h2>
    <p>We do not have a verified reader savings dataset or subscriber count to publish. Figures in personal articles are the author’s reported experience, not an average or a promise. Calculator results are estimates based on the inputs and listed alternatives.</p>
    ...
    <p>Legacy articles record April 2026, without an exact publication day. We retain that level of precision instead of inventing timestamps. A technical site update is not a fresh product test. Changes to pricing, models, limits, observed behavior or factual errors warrant an editorial review. Exact test and revision dates should accompany future documented updates.</p>
