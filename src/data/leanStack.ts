...
export type Product = { id: string; name: string; category: Category; categoryName: string; price: string; url: string; pricingUrl: string; affiliate: boolean; fit: string; use: string; skip: string; alternative: string };
// Free-tier availability checked against these official sources on 2026-09-18.
// No paid prices or exchange-rate assumptions. Affiliate links must be verified before enabling.
export const products: Record<string, Product> = {
  chatgpt: { id:'chatgpt', name:'ChatGPT', category:'assistant', categoryName:'Writing and research', price:'Free plan; usage limits apply', url:'https://chatgpt.com/', pricingUrl:'https://chatgpt.com/pricing/', affiliate:false, fit:'One assistant can help outline, draft and summarize without adding separate writing subscriptions.', use:'People who can review outputs and verify important facts.', skip:'Skip a paid plan until free limits interrupt useful work. Do not enter confidential customer data without checking your policies.', alternative:'Write in your existing document editor and research original sources.' },
  canva: { id:'canva', name:'Canva', category:'design', categoryName:'Design and media', price:'Free plan; premium assets cost extra', url:'https://www.canva.com/', pricingUrl:'https://www.canva.com/pricing/', affiliate:false, fit:'Reusable templates reduce the time spent on repeat visuals.', use:'Creators and teams making straightforward branded graphics.', skip:'Skip an upgrade if basic templates and your own assets cover the job.', alternative:'Reuse existing brand templates and native image editing tools.' },
  notion: { id:'notion', name:'Notion', category:'workspace', categoryName:'Content calendar and project management', price:'Free individual plan; team limits apply', url:'https://www.notion.com/', pricingUrl:'https://www.notion.com/pricing', affiliate:false, fit:'Keep your tasks and content calendar in one place.', use:'Solo builders who want a simple list, calendar and notes.', skip:'Skip a new workspace if your current one works. Teams should check collaboration limits before inviting everyone.', alternative:'An existing shared document or spreadsheet with an owner and due date.' },
  kit: { id:'kit', name:'Kit', category:'email', categoryName:'Email and newsletter', price:'Free Newsletter plan; features and subscriber limits apply', url:'https://kit.com/', pricingUrl:'https://kit.com/pricing', affiliate:false, fit:'One permission-based list and welcome message are enough to start publishing.', use:'Content businesses and creators ready to build an email audience.', skip:'Skip advanced sequences before a basic newsletter and signup form are working.', alternative:'Use your existing email platform’s basic plan; do not move a working list just to switch tools.' },
  zapier: { id:'zapier', name:'Zapier', category:'automation', categoryName:'Automation', price:'Free plan for limited simple automations', url:'https://zapier.com/', pricingUrl:'https://zapier.com/pricing', affiliate:false, fit:'Start with one simple connection between tools you already use.', use:'Beginners with a stable, recurring task supported by the free plan.', skip:'Skip it if the task happens rarely or needs paid apps and multi-step workflows.', alternative:'A checklist or a native integration in your existing software.' },
  make: { id:'make', name:'Make', category:'automation', categoryName:'Automation', price:'Free plan; credit and scheduling limits apply', url:'https://www.make.com/', pricingUrl:'https://www.make.com/en/pricing', affiliate:false, fit:'Visual scenarios suit people comfortable mapping data and troubleshooting connections.', use:'Confident users who can test and maintain a repeatable workflow.', skip:'Skip complex scenarios before you know the manual process works.', alternative:'Native integrations or a manual checklist; technical users can evaluate a small script they can maintain.' },
  wordpress: { id:'wordpress', name:'WordPress.com', category:'website', categoryName:'Website and product validation', price:'Free hosted site; custom domain and selling features may require payment', url:'https://wordpress.com/', pricingUrl:'https://wordpress.com/pricing/', affiliate:false, fit:'Validate an idea with a simple hosted page before buying a full website stack.', use:'Beginners publishing content, a service offer or an early product description.', skip:'The free plan is not a complete SaaS application or ecommerce checkout.', alternative:'A page on your existing website, or a simple offer document shared with prospective customers.' },
  github: { id:'github', name:'GitHub', category:'website', categoryName:'Product development', price:'Free plan; compute and advanced features have limits', url:'https://github.com/', pricingUrl:'https://github.com/pricing', affiliate:false, fit:'Keep product source code, issues and change history together.', use:'Technical founders building and testing their own application.', skip:'Skip it as your primary builder if you need guided no-code setup. Hosting, a database and checkout are separate costs.', alternative:'Validate the offer manually on your current website before developing an application.' },
