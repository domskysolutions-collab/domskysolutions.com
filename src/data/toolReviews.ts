...
export const toolReviews = {
  'claude': {
    ...
    bestFor: [
      ...
      "If your primary use case is image generation or you need real-time web search built in, look elsewhere. But for thinking, writing, and reasoning? Claude is my top pick."
    ],
    verdict: "Claude by Anthropic is the AI assistant I recommend to almost everyone starting out with AI tools. The free plan is good enough to get real work done, the Pro plan at $20/month is one of the best value subscriptions in the AI space, and the quality of output consistently beats the competition on writing and reasoning tasks.\n\nIf you only try one AI tool this year, make it Claude.",
  ...
  'runway': {
    ...
    verdict: "Runway is the most impressive creative AI tool I have reviewed, full stop. The gap between what is possible with Runway today and what required a professional production team twelve months ago is staggering, and that gap is widening with every model update they ship.\n\nThe credit system and pricing can frustrate heavy users, and the free tier genuinely is too limited to form a proper opinion of what the tool can do at its best. My recommendation is to start with the Standard plan at $15/month, spend a month really learning the tool, and upgrade to Pro once you understand how to get consistently great results from it.\n\nFor anyone in a creative field, Runway is not optional much longer. The creators and teams adopting it now are building a significant competitive advantage over those waiting to see how the technology matures. It is already mature enough to matter.",
