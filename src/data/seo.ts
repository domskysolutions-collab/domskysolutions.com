...
export const seoPages: PageSeo[] = [
  ...
  ...AI_TOOLS.map(tool => ({ path: `/tools/${tool.slug}`, title: tool.seoTitle, description: tool.seoDescription })),
...
export function structuredData(meta: PageSeo) {
  ...
  const organization = { '@type': 'Organization', '@id': `${SITE_URL}/#organization`, name: 'Domsky Solutions', url: SITE_URL, logo: `${SITE_URL}/images/domsky-logo.png`, founder: { '@id': author['@id'] } };
