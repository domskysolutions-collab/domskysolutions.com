...
import { retiredUtilityRedirects } from './data/utilityRoutes';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {Object.entries(retiredUtilityRedirects).map(([from, to]) => <Route key={from} path={from} element={<Navigate replace to={to} />} />)}
